...
!["Types of headache meme showing from left to right, diagrams of migraine, hypertension, and stress headache regions highlighted in red. On the lower right quadrant, a diagram with a full head in red is labelled 'Configuring NixOS'"](/static/images/blog/installing-lazyvim-on-nixos/types-of-headache.jpg)
