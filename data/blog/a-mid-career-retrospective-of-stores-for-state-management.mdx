...
All fields and validations that depended on selected form values all relied on runtime checks against a JSON file with 280 combinations of custom form validation rules.
