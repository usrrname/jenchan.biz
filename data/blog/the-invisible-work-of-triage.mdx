...
I've had the luck of introducing feature request and [bug triage](/blog/bug-triage) at a previous workplace while working as a UX developer on a team of 12 on an idea-to-MVP project at a health startup.

I first learned of issue triage as a support drone with way too much access to prod while working on a product that had 300 municipal customers. Several times a day I'd hop on a call with a CPO to (hassle him to) make decisions on escalated customer issues and relay the handoff or feedback to and from developers. Later these skills translated to subsequent dev roles where discussing triage and related issues seemed a lightning rod depending on the environment. At that point, my role as not-real-dev and troubleshooter was to be a buffer between devs and PMs. With the continued tightening of engineering budgets in 2024, most workplaces are likely expected to do more with less, so triage and prioritization is a great skill to have in your back pocket.

## Competing incentives 

From a non-engineering management perspective, any maintenance or tech debt can be thought of as a nuisance, taking your most expensive resource from focusing on activities that generate revenue: building and shipping new features. 

I'm not surprised if developers don't eagerly volunteer to bug sweep on Sentry or resolve customer support fires. 
...
And yet, both backlog and bug triage are crucial to maintaining the ability to ship fast and resolve errors quickly. 
...
If the manager isn't technical, often some random unlucky dev gets assigned a ticket they have no idea how to fix or reproduce, and hopefully the 1-3 originary implementing devs, and try to reproduce and fix it without blowing through their already-missing time from the sprint.
...
## Triage: process introduction as lightning rod
