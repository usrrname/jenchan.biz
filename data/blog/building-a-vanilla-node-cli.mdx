...
<div className="flex flex-col gap-x-2 sm:flex-row">
  <LinkCard
    ...
    date="2023-02-13"
    description="I’m a maintainer of several dozen open source libraries. One thing I’ve always done is maintain a hand-written changelog."
  />
  <LinkCard
    className="w-full sm:w-[50%]"
...
To sales, the choice of technology is just an implementation detail. For developers, it becomes an exercise of working with the hell of previous decisions.
