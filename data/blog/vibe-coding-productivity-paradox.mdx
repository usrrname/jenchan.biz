...
Adoption of AI becomes another to-do list item to find the least shitty autocompleter or rubber ducking replacement- if your work has budget in this economy. [^1]
...
Not pictured: Glaring disjunctions between your quarterly goals, arms-race-style LLM releases and unsexy day-to-day software maintenance. 
...
![Persian cat meme](https://media1.tenor.com/m/mOR-MnUI3QEAAAAC/confused-white-persian-guardian.gif)

What's the ROI?! Where is this growth in [GDP per FTE](https://www.mckinsey.com/~/media/mckinsey/business%20functions/mckinsey%20digital/our%20insights/the%20economic%20potential%20of%20generative%20ai%20the%20next%20productivity%20frontier/the-economic-potential-of-generative-ai-the-next-productivity-frontier.pdf)? [^5]


## Is natural language the right abstraction for building software?

<LinkCard 
    title="@usrrname/cursorrules"
    image="https://usrrname.github.io/cursorrules/img/sara-gets-playful-with-vicodin.jpg"
    description="The article you're reading was inspired by my recent attempt to build a standard library in Cursor in order to keep up with the joneses." 
    url="https://github.com/usrrname/cursorrules" />

<LinkCard 
    title="Agentic AI Workflow Woes"
    image=""
    description="A deeper look at problems I had with setting up an agentic workflow in Cursor." 
    url="https://usrrname.github.io/cursorrules" />

Through Cursor rulegen and prompt-based workflows, I've noticed pretty significant shifts in how I think as I worked from basic rulegen to coordinating and testing workflows. At the moment, I can't tell if I haven't adapted sufficiently or we haven't figured out the ideal way humans can interface with LLMs to be productive beyond basic tasks.
...
[^5]: McKinsey, ["The Economic Potential of Generative AI: The Next Productivity Frontier"](https://www.mckinsey.com/~/media/mckinsey/business%20functions/mckinsey%20digital/our%20insights/the%20economic%20potential%20of%20generative%20ai%20the%20next%20productivity%20frontier/the-economic-potential-of-generative-ai-the-next-productivity-frontier.pdf)