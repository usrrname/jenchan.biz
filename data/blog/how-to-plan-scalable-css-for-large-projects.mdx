...
Having to remember to use `Bd` to create a 1px border anytime I want it on a particular element. Then,
if that element contains text, I'll be using `Lh(1.5)` to indicate it has a line height of 1.5em and
...
<caption>
  {' '}
  [SMACSS](http://smacss.com/), pronounced "smacks" aka "scalable and modular architecture for css"{' '}
</caption>
