/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./types/cloudflare-env.d.ts` (hash: 1b0e3155eca542bb22cd11cc3dbbb6f9)
// Runtime types generated with workerd@1.20250712.0 2025-03-25 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface Env {
    NEXTJS_ENV: string
    NEXT_INC_CACHE_R2_BUCKET: string
    WORKER_SELF_REFERENCE: string
    ASSETS: string
    GITHUB_TOKEN: string
    NEXT_DEVTO_API_KEY: string
    NEXT_GOOGLE_ANALYTICS_ID: string
    NEXT_WEBMENTION_TOKEN: string
    NEXT_INC_CACHE_R2_BUCKET: R2Bucket
    WORKER_SELF_REFERENCE: Fetcher /* jenchan-biz */
    ASSETS: Fetcher
  }
}
